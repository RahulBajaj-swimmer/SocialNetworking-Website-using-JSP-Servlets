		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3">
                    ...
                    <%
                        try
                        {
                            ...
                            String qry="select a.sno,a.usrid,b.userimg from tbfriend a,tbuser b where a.fid='"+uid+"' and a.status=0 and a.usrid=b.usrid";
                            ...
                            <%
                                while(rs.next())
                                {
                                    %>
                                    <tr>
                                        <td><a href="request.jsp?id=<%=rs.getString("usrid")%>&sno=<%=rs.getString("sno")%>"><img src="<%=rs.getString("userimg")%>" height="100" width="100"></a></td>
                                        <td><a href="request.jsp?id=<%=rs.getString("usrid")%>&sno=<%=rs.getString("sno")%>"><%=rs.getString("usrid")%></a></td>
                                    </tr>
