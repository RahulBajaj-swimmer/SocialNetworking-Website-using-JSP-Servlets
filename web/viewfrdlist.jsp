                    ...
                    <br><br>
                     ...
                     <%
                        try
                        {
                            ...
                            String qry="select a.fid,b.userimg from tbfriend a,tbuser b where a.usrid='"+uid+"' and a.status=1 and a.fid=b.usrid";
                            ...
                            <table>
                                <%
                                    while(rs.next())
                                    {
                                        %>
                                        <tr>
                                            <td style="width: 43px"><a href="sendmsg.jsp?fid=<%=rs.getString("fid")%>">
											<img src="<%=rs.getString("userimg")%>" height="100" width="100"></a></td>
                                            <td style="width: 142px"><a href="sendmsg.jsp?fid=<%=rs.getString("fid")%>"><%=rs.getString("fid")%></a></td>
                                        </tr>
                                        <%
