...
<head>
    <script type="text/javascript">
        function check(f)
        {
            grp=document.getElementById("a").value;
            var e1=document.getElementById("d1");
            flag=true;
            
             if(grp=="")
            {
                e1.innerHTML="<font color=red>Please Enter Group Name to proceed !!</font>";
                flag=false;
            }
            else
            {
    ...
    <div class="content">
      <div class="content_bg">
		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3" class="style1">
			<h1><strong>CREATE NEW GROUP<br />
			
			
                            </strong></h1>
			<form method="post" action="creategrp2.jsp" name="f1" onsubmit="return check(f1)" style="height: 482px">
				<br />
				<strong><br />
				</strong>
				<input name="Text1" type="text" id="a" style="width: 485px; height: 80px" />
				<br />
                                <font size="4"><small><span id="d1"></span></small></font>
                                <br/>
				<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="Submit1" type="submit" value="CREATE GROUP" style="width: 185px; height: 67px" /></form>
			</div>
		<br />
		<br />
		<br />
