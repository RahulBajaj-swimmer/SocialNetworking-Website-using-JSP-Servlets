		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3">
                    ...
                    <%
                        try
                        {
                            ...
                            String qry="select topicid,topicdesc from tbtopic where topicgid="+ gid;
                            ResultSet rs=new DB().execute(qry);
                            
                            while(rs.next())
                            {
                                %>
                                <p style="color: #0000FF; border: 1px dotted black; padding: 10px; font-weight:bold">
                                     <a href="blogdetails.jsp?tid=<%=rs.getString("topicid")%>"><%=rs.getString("topicdesc")%></a>
                                    </p>
                                <br>
                                <%
                            }
