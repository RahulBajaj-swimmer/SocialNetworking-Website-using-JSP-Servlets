      ...
      <div class="content_bg">
		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3">
                    ...
                    <%
                        try
                        {
                        String nm=request.getParameter("Text1");
                        String ad=request.getParameter("Text2");
                        String m=request.getParameter("Text3");
                        String qual=request.getParameter("Text4");
                        String inter=request.getParameter("Text5");
                        String dob =request.getParameter("Text6");
                        
                        String qry="update tbuser set usrname='"+nm+"' , usradd='"+ad+
                        "', usrmob='"+m+"', usrqualification='"+qual+"', usrinterest='"+inter+"', usrdob='"+dob+
                        "' where usrid='"+session.getAttribute("uid")+"'";
