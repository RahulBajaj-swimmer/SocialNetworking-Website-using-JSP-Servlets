      ...
      <div class="content_bg">
		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3">
                    ...
                    <%
                        ...
                        String qry="update tbfriend set status=1 where sno="+sno;
                        System.out.println(qry);
                        new DB().update(qry);
                        
                        int newsno= new DB().getSno();
                        String uid=(String)session.getAttribute("uid");
                        String id=request.getParameter("id");
                        qry="insert into tbfriend values("+newsno+",'"+uid+"','"+id+"',1)";
                        new DB().update(qry);
                        
                        out.println("<h1>Request accepted successfully !!</h1>");
                        }
                        catch(Exception e)
                        {
