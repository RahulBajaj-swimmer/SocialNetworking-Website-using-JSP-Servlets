      ...
      <div class="content_bg">
		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3">
                    ...
                    <%
                        try
                        {
                            String u=request.getParameter("Select1");
                            String v=request.getParameter("Text1");
                            
                            String qry="update tbuser set usrsecques='"+u+"',usrsecans='"+v+"' where usrid='"+session.getAttribute("uid")+"'";
                            new DB().update(qry);
                            %>
                            <h1> SECURITY SETTINGS UPDATED SUCCESSFULLY !!</h1>
                            <br><br>
