		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3">
                    ...
                    <%
                        try
                        {
                            ...
                            String qry="select a.membergid,b.groupdesc from tbgroupmember a,tbgroup b where a.memberusrid='"+uid+"' and a.membergid=b.groupid";
                            ...
                            while(rs.next())
                            {
                                %>
                                <tr>
                                    <td><h2><a href="grpdetails.jsp?gid=<%=rs.getString("membergid")%>&gn=<%=rs.getString("groupdesc")%>"><%=rs.getString("groupdesc")%></a></h2><br><br></td>
