      ...
      <div class="content_bg">
		...
		<div style="position: absolute; width: 696px; height: 704px; z-index: 3; left: 521px; top: 520px" id="layer3">
                    <%
                         ...
                         {
                             DB obj=new DB();
                             int tid=obj.getNewId("tbtopic", "topicid");
                            ...
                            String tm= sdf2.format(d);
                            
                            String qry="insert into tbtopic values("+tid+",'"+desc+"','"+dt+"','"+tm+"','"+uid+"',"+gid+")";
                            obj.update(qry);
                            out.println("<h1>Blog Posted Successfully !</h1>");
