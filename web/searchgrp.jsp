                    ...
                    <%
                        try
                        {
                            ...
                            out.println("<table>");                 
                             ...
                             %>
                             <tr>
                                 <td><h2><%=rs.getString("groupdesc")%></h2><br/><br/><br/></td>
                                 <%
                                     String uid=(String)session.getAttribute("uid");
                                     String grpowner=rs.getString("groupowner");
                                     if(grpowner.equals(uid))
                                     {
                                         out.println("<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>");
                                         out.println("<td><h3>YOU ARE OWNER OF THIS GROUP !!</h3><br><br><br></td>");
                                     }
                                     else
                                     {
                                     %>  
                                                ...
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td><h3><a href="joingrp.jsp?gid=<%=rs.getString("groupid")%>">Join Group</a></h3><br><br><br></td>
                                ...
                                <%
                                     ...
                                     %>
                                     <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                         <td><a href="grpdetails.jsp?gid=<%=rs.getString("groupid")%>&gn=<%=rs.getString("groupdesc")%>">GROUP DETAILS</a><br><br>
                                                 <br><br></td>
